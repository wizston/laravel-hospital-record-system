...
<div class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		<div class="navbar-header">
			<a href="{{ url('management/dashboard') }}" class="navbar-brand"><img src="{{ url('img/logo2.png') }}" style="width: 52%;" alt="Hospital Record System"></a>
		...
		<div class="navbar-collapse collapse" id="navbar-main">
			<ul class="nav navbar-nav">
				<li>
					<a href="{{ url('management/dashboard') }}" class="active">Dashboard</a>
				</li>
				<li>
					<a href="{{ url('management/reports') }}">Reports</a>
				</li>
				<li>
					<a href="{{ url('management/new-doctor') }}">Register</a>
				</li>
			</ul>
